...
from mpscli.structuregen.gen.EscapeUtil import escape_if_python_keyword, escape_sunder
...
class EnumDeclarationTemplateHelper(AbstractDeclarationTemplateHelper):
    ...
    def get_members(self):
        ...
        return [(escape_sunder(escape_if_python_keyword(literal.get_property("name"))), literal.get_property("presentation")
            if literal.get_property("presentation") is not None else literal.get_property("name")) for literal in members]
