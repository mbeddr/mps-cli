...
class TestLanguageStructureGenerator(TestBase):
    ...
    def test_smoke_class_exist(self):
        ...
        lib = lib_class("1234", "mps.cli.landefs.library.structure.Library", None, None)
    ...
    def test_using_classes(self, test_data_location):
        ...
        module = importlib.import_module("jetbrains.mps.lang.core.structure.INamedConcept")
        named_concept_class = getattr(module, "INamedConcept")
